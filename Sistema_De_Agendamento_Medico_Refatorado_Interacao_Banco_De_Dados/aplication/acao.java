package JDBC.Sistema_De_Agendamento_Medico_refatorado_Enum_Interacao_Banco_De_Dados.aplication;

import JDBC.Sistema_De_Agendamento_Medico_refatorado_Enum_Interacao_Banco_De_Dados.Repository.PacienteRepository;
import JDBC.Sistema_De_Agendamento_Medico_refatorado_Enum_Interacao_Banco_De_Dados.entities.Paciente;
    ...
    public static void main(String[] args) throws SQLException {
        ...
        try {
            ...
            while (continuar) {
                ...
                int opcao;
                // Converte o texto digitado em número; se não for número, cai no catch de NumberFormatException
                ...
                switch (opcao) {
                    ...
                    case 1 -> {
                        ...
                        // \\d{11} permite somente números com limetes de 11
                        ...
                        // Verifica se o nome contém algum número (nome não pode ter dígitos)
                        if (nome.matches(".*\\d.*")){
                    ...
                    case 4 -> {
                        ...
                        // Tenta deletar o paciente; retorna true se encontrou e removeu, false se não achou o CPF
            ...
            // Captura erros de acesso ao banco de dados (conexão, SQL, etc.)
